...
namespace Org.BouncyCastle.Bcpg
{
    ...
    */
        ...
        : BaseOutputStream
    {
        ...
        private static readonly string Version = "BCPG C# v" + Assembly.GetEntryAssembly().GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion;
